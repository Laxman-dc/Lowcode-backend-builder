...
function Dashboard() {
  return (
    <div className="dashboard-container">
      ...
      <p>Get started with one of the options below and start accelerating development with no-code.</p>
      <div className="dashboard-grid">
        <div className="dashboard-card">
          <h2>Check out the tutorial</h2>
          <p>A guided use case to help you learn how Xano can help you build a great backend.</p>
        ...
        <div className="dashboard-card">
          ...
          <p>Connect with fellow Xano users, seek assistance, and discover resources to enhance your journey.</p>
          <button className="secondary-btn">Join our community</button>
        </div>

        <div className="dashboard-card">
          <h2>Quickstart guide</h2>
          <p>Take a look at our curated selection of videos and suggested tasks to help you get familiar with Xano.</p>
        ...
        <div className="dashboard-card">
          <h2>Build an API</h2>
          <p>Ready to dig in? Start building an API endpoint using Xano's no-code API builder.</p>
          <button className="primary-btn">Add an endpoint</button>
        </div>

        <div className="dashboard-card">
          <h2>Bring your data into Xano</h2>
          <p>Import your data from Airtable or CSV. You can also copy and paste data into a database table.</p>
        ...
        <div className="dashboard-card">
          ...
          <p>Xano can automatically set up user authentication/login with email and OAuth services.</p>
